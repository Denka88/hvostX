...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 01 2026 г., 02:14
...
CREATE TABLE `partners` (
  ...
  `is_active` tinyint(1) DEFAULT 1,
  `partner_order` int(11) DEFAULT 0,
  `created_at` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'admin', 'Администратор', 'admin@hvostx.ru', '', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'avatar_1_1772131232.jpeg', 'admin', '2026-02-25 20:13:08', '2026-02-26 21:40:32');
